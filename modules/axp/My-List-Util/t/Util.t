...
TODO: {
	local $TODO = "Need to implement sum and shuffle";
	...
	is( My::List::Util::sum( '3', '6ix', 'one' ), 9, 'Ignore characters' );
	
	warning_like { My::List::Util::sum( 'y' ) } qr/^Argument "y" isn't numeric/, "Non-numeric warning";
